...
impl ParamSet {
    ...
    /// Message space prime
    pub fn get_p(&self) -> i8 { self.p }
    /// Product form +1/-1 counts
    pub fn get_d1(&self) -> u8 { self.d1 }
    /// Product form +1/-1 counts
    pub fn get_d2(&self) -> u8 { self.d2 }
    /// Product form +1/-1 counts
    pub fn get_d3(&self) -> u8 { self.d3 }
    ...
    pub fn privkey_packed_bytes(&self) -> usize {
        5 + 2 * ((2 * (
                self.d1 as usize + self.d2 as usize + self.d3 as usize) * self.n_bits as usize + 7
